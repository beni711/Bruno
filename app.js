...
const ONLINE_SESSION_STORAGE_KEY = "0160e4b3e0c426ecaea81be0b8bdbd6de0694e75b45a10d97b12a746069204ba";
...
function startGame() {
  ...
  try {
    ...
    if (game.maxCards !== selectedMaxCards || game.rounds.length !== selectedRoundCount) {
